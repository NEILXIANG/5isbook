...
public class Category extends ActionSupport{
	...
	@Resource(name="categoryConfigeServiceProvider")
	public void setConfigeService(ConfigeService configeService) {
		this.configeService = configeService;
	}

	public String execute() throws Exception{
		org.springframework.core.io.Resource resource = new FileSystemResource("E:\\_Mspace\\项目\\二手书交易平台\\5isbook\\src\\5isbook\\WebContent\\WEB-INF\\configuration\\category.xml");
