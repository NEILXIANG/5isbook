...
public class ExcelGenerator {
    ...
    public static void createSheet(Workbook template, String sheetName, List<String> header, List<Map<String, Object>> data) {
        Sheet sheet = template.createSheet(sheetName);
        ...
        MapAbsObj headerMapAbsObj = HeaderExtractor.extraHeader(sheet);
        fillDataFromRow(sheet, data, headerMapAbsObj);
    }
